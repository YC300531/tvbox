...
public final class OpenSSLProvider extends Provider {
    ...
    public OpenSSLProvider(String str) {
        this(str, Platform.provideTrustManagerByDefault(), NativeCrypto.SUPPORTED_PROTOCOL_TLSV1_3);
    }
    ...
    public OpenSSLProvider(String str, boolean z, String str2) {
        ...
        if (str2.equals("TLSv1.2")) {
            str3 = "$TLSv12";
        } else if (!str2.equals(NativeCrypto.SUPPORTED_PROTOCOL_TLSV1_3)) {
            throw new IllegalArgumentException(b.b("Choice of default protocol is unsupported: ", str2));
        } else {
            str3 = "$TLSv13";
        }
        ...
        sb3.append(str4);
        androidx.base.r5.b.i(sb3, "DefaultSSLContextImpl", str3, this, "SSLContext.Default");
        if (z) {
        ...
        StringBuilder h = androidx.base.r5.b.h(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.22", "AES", "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.42", "AES");
        h.append(str4);
        h.append("IvParameters$ChaCha20");
        put("AlgorithmParameters.ChaCha20", h.toString());
        androidx.base.r5.b.i(new StringBuilder(), str4, "IvParameters$DESEDE", this, "AlgorithmParameters.DESEDE");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.AlgorithmParameters.TDEA", "DESEDE", "Alg.Alias.AlgorithmParameters.1.2.840.113549.3.7", "DESEDE"), str4, "GCMParameters", this, "AlgorithmParameters.GCM");
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.6", "GCM");
        StringBuilder h2 = androidx.base.r5.b.h(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.26", "GCM", "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.46", "GCM");
        h2.append(str4);
        h2.append("OAEPParameters");
        put("AlgorithmParameters.OAEP", h2.toString());
        put("AlgorithmParameters.PSS", str4 + "PSSParameters");
        put("AlgorithmParameters.EC", str4 + "ECParameters");
        androidx.base.r5.b.i(new StringBuilder(), str4, "OpenSSLMessageDigestJDK$SHA1", this, "MessageDigest.SHA-1");
        put("Alg.Alias.MessageDigest.SHA1", EvpMdRef.SHA1.JCA_NAME);
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.MessageDigest.SHA", EvpMdRef.SHA1.JCA_NAME, "Alg.Alias.MessageDigest.1.3.14.3.2.26", EvpMdRef.SHA1.JCA_NAME), str4, "OpenSSLMessageDigestJDK$SHA224", this, "MessageDigest.SHA-224");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.MessageDigest.SHA224", EvpMdRef.SHA224.JCA_NAME, "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.4", EvpMdRef.SHA224.JCA_NAME), str4, "OpenSSLMessageDigestJDK$SHA256", this, "MessageDigest.SHA-256");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.MessageDigest.SHA256", EvpMdRef.SHA256.JCA_NAME, "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.1", EvpMdRef.SHA256.JCA_NAME), str4, "OpenSSLMessageDigestJDK$SHA384", this, "MessageDigest.SHA-384");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.MessageDigest.SHA384", EvpMdRef.SHA384.JCA_NAME, "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.2", EvpMdRef.SHA384.JCA_NAME), str4, "OpenSSLMessageDigestJDK$SHA512", this, "MessageDigest.SHA-512");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.MessageDigest.SHA512", EvpMdRef.SHA512.JCA_NAME, "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.3", EvpMdRef.SHA512.JCA_NAME), str4, "OpenSSLMessageDigestJDK$MD5", this, "MessageDigest.MD5");
        put("Alg.Alias.MessageDigest.1.2.840.113549.2.5", EvpMdRef.MD5.JCA_NAME);
        put("KeyGenerator.ARC4", str4 + "KeyGeneratorImpl$ARC4");
        StringBuilder h3 = androidx.base.r5.b.h(this, "Alg.Alias.KeyGenerator.RC4", "ARC4", "Alg.Alias.KeyGenerator.1.2.840.113549.3.4", "ARC4");
        h3.append(str4);
        h3.append("KeyGeneratorImpl$AES");
        put("KeyGenerator.AES", h3.toString());
        put("KeyGenerator.ChaCha20", str4 + "KeyGeneratorImpl$ChaCha20");
        androidx.base.r5.b.i(new StringBuilder(), str4, "KeyGeneratorImpl$DESEDE", this, "KeyGenerator.DESEDE");
        ...
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyGenerator.HMAC-MD5", "HmacMD5", "Alg.Alias.KeyGenerator.HMAC/MD5", "HmacMD5"), str4, "KeyGeneratorImpl$HmacSHA1", this, "KeyGenerator.HmacSHA1");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.7", "HmacSHA1");
        put("Alg.Alias.KeyGenerator.1.3.6.1.5.5.8.1.2", "HmacSHA1");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyGenerator.HMAC-SHA1", "HmacSHA1", "Alg.Alias.KeyGenerator.HMAC/SHA1", "HmacSHA1"), str4, "KeyGeneratorImpl$HmacSHA224", this, "KeyGenerator.HmacSHA224");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.8", "HmacSHA224");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyGenerator.HMAC-SHA224", "HmacSHA224", "Alg.Alias.KeyGenerator.HMAC/SHA224", "HmacSHA224"), str4, "KeyGeneratorImpl$HmacSHA256", this, "KeyGenerator.HmacSHA256");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.9", "HmacSHA256");
        put("Alg.Alias.KeyGenerator.2.16.840.1.101.3.4.2.1", "HmacSHA256");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyGenerator.HMAC-SHA256", "HmacSHA256", "Alg.Alias.KeyGenerator.HMAC/SHA256", "HmacSHA256"), str4, "KeyGeneratorImpl$HmacSHA384", this, "KeyGenerator.HmacSHA384");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.10", "HmacSHA384");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyGenerator.HMAC-SHA384", "HmacSHA384", "Alg.Alias.KeyGenerator.HMAC/SHA384", "HmacSHA384"), str4, "KeyGeneratorImpl$HmacSHA512", this, "KeyGenerator.HmacSHA512");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.11", "HmacSHA512");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyGenerator.HMAC-SHA512", "HmacSHA512", "Alg.Alias.KeyGenerator.HMAC/SHA512", "HmacSHA512"), str4, "OpenSSLRSAKeyPairGenerator", this, "KeyPairGenerator.RSA");
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.1", "RSA");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.7", "RSA", "Alg.Alias.KeyPairGenerator.2.5.8.1.1", "RSA"), str4, "OpenSSLECKeyPairGenerator", this, "KeyPairGenerator.EC");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyPairGenerator.1.2.840.10045.2.1", "EC", "Alg.Alias.KeyPairGenerator.1.3.133.16.840.63.0.2", "EC"), str4, "OpenSSLRSAKeyFactory", this, "KeyFactory.RSA");
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.1", "RSA");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyFactory.1.2.840.113549.1.1.7", "RSA", "Alg.Alias.KeyFactory.2.5.8.1.1", "RSA"), str4, "OpenSSLECKeyFactory", this, "KeyFactory.EC");
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.KeyFactory.1.2.840.10045.2.1", "EC", "Alg.Alias.KeyFactory.1.3.133.16.840.63.0.2", "EC"), str4, "DESEDESecretKeyFactory", this, "SecretKeyFactory.DESEDE");
        ...
        androidx.base.r5.b.i(androidx.base.r5.b.h(this, "Alg.Alias.Mac.HMAC/SHA512", "HmacSHA512", "Alg.Alias.Mac.PBEWITHHMACSHA512", "HmacSHA512"), str4, "OpenSSLX509CertificateFactory", this, "CertificateFactory.X509");
    ...
    private void putECDHKeyAgreementImplClass(String str) {
        ...
        putImplClassWithKeyConstraints("KeyAgreement.ECDH", b.b(str2, str), sb.toString(), "PKCS#8");
    }
    ...
    private void putMacImplClass(String str, String str2) {
        StringBuilder sb = new StringBuilder();
        String str3 = PREFIX;
        putImplClassWithKeyConstraints(b.b("Mac.", str), b.b(str3, str2), b.c(sb, str3, "OpenSSLKeyHolder"), "RAW");
    }
    ...
    private void putRAWRSASignatureImplClass(String str) {
        ...
        putImplClassWithKeyConstraints("Signature.NONEwithRSA", b.b(str2, str), sb.toString(), null);
    }
    ...
    private void putRSACipherImplClass(String str, String str2) {
        ...
        sb.append("OpenSSLRSAPublicKey|");
        sb.append(STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME);
        putImplClassWithKeyConstraints(b.b("Cipher.", str), b.b(str3, str2), sb.toString(), null);
    }
    ...
    private void putSignatureImplClass(String str, String str2) {
        ...
        sb.append("|");
        sb.append(STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME);
        putImplClassWithKeyConstraints(b.b("Signature.", str), b.b(str3, str2), sb.toString(), "PKCS#8|X.509");
    }

    private void putSymmetricCipherImplClass(String str, String str2) {
        putImplClassWithKeyConstraints(b.b("Cipher.", str), b.c(new StringBuilder(), PREFIX, str2), null, "RAW");
    }
}
