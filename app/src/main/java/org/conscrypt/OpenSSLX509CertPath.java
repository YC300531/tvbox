...
final class OpenSSLX509CertPath extends CertPath {
    ...
    public static class fun1 {
        public static final int[] $SwitchMap$org$conscrypt$OpenSSLX509CertPath$Encoding;
    ...
    public static CertPath fromEncoding(InputStream inputStream, String str) {
        if (inputStream != null) {
            ...
            throw new CertificateException(b.b("Invalid encoding: ", str));
        }
        throw new CertificateException("inStream == null");
    }

    private static CertPath fromEncoding(InputStream inputStream, Encoding encoding) {
        int i = fun1.$SwitchMap$org$conscrypt$OpenSSLX509CertPath$Encoding[encoding.ordinal()];
        if (i != 1) {
            if (i == 2) {
    ...
    private byte[] getEncoded(Encoding encoding) {
        ...
        int i3 = fun1.$SwitchMap$org$conscrypt$OpenSSLX509CertPath$Encoding[encoding.ordinal()];
        if (i3 != 1) {
            if (i3 == 2) {
    ...
    public byte[] getEncoded(String str) {
        ...
        throw new CertificateEncodingException(b.b("Invalid encoding: ", str));
    }
