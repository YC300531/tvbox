...
public abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    public int engineDoFinal(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        StringBuilder d = b.d("output buffer is too small ");
        d.append(bArr2.length);
        d.append(" < ");
        d.append(length);
    ...
    public byte[] engineDoFinal(byte[] bArr, int i, int i2) {
        ...
        if (this.inputTooLarge) {
            throw new IllegalBlockSizeException(a.k(b.d("input must be under "), this.buffer.length, " bytes"));
        }
    ...
    public void engineInit(int i, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) {
        ...
        d.append(algorithmParameters.getClass().getName());
    ...
    public void engineSetMode(String str) {
        ...
        if (!"NONE".equals(upperCase) && !"ECB".equals(upperCase)) {
            throw new NoSuchAlgorithmException(b.b("mode not supported: ", str));
        }
    }
    ...
    public void engineSetPadding(String str) {
        ...
        if ("PKCS1PADDING".equals(upperCase)) {
            ...
            throw new NoSuchPaddingException(b.b("padding not supported: ", str));
        } else {
            i = 3;
        }
        this.padding = i;
