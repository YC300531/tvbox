...
public final class NativeSsl {
    ...
    public final class BioWrapper {
        ...
        public BioWrapper(NativeSsl nativeSsl, 1 r2) {
            this();
        }
        ...
        public int readDirectByteBuffer(long j, int i) {
            ...
            try {
                ...
                return NativeCrypto.ENGINE_SSL_read_BIO_direct(ssl, NativeSsl.this, this.bio, j, i, handshakeCallbacks);
            } finally {
                lock.readLock().unlock();
            }
        }
        ...
        public int writeDirectByteBuffer(long j, int i) {
            ...
            try {
                ...
                return NativeCrypto.ENGINE_SSL_write_BIO_direct(ssl, NativeSsl.this, this.bio, j, i, handshakeCallbacks);
            } finally {
                lock.readLock().unlock();
            }
        }
    ...
    private void verifyWithSniMatchers(String str) {
        if (AddressUtils.isValidSniHostname(str) && !Platform.serverNamePermitted(this.parameters, str)) {
            throw new SSLHandshakeException(b.b("SNI match failed: ", str));
        }
    }
    ...
    public void initialize(String str, OpenSSLKey openSSLKey) {
        ...
        if (!isClient()) {
            NativeCrypto.SSL_set_options(this.ssl, this, PlaybackStateCompat.ACTION_SET_PLAYBACK_SPEED);
    ...
    public BioWrapper newBio() {
        try {
            return new BioWrapper(this, null);
