    ...
    public static String[] decodeProtocols(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            ...
            if (b < 0 || b > bArr.length - i2) {
                StringBuilder o = a.o("Protocol has invalid length (", b, " at position ", i2, "): ");
                o.append(bArr.length < 50 ? Arrays.toString(bArr) : a.k(new StringBuilder(), bArr.length, " byte array"));
    ...
    public static byte[] encodeProtocols(String[] strArr) {
        if (strArr != null) {
            ...
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (strArr[i2] == null) {
                    throw new IllegalArgumentException(b.a("protocol[", i2, "] is null"));
                }
                int length = strArr[i2].length();
                if (length == 0 || length > 255) {
                    throw new IllegalArgumentException(androidx.base.r5.b.c("protocol[", i2, "] has invalid length: ", length));
                }
                i += length + 1;
            }
